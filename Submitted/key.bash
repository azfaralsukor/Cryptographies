#!/bin/bash
P="AaBbCcDdEeFfGgHhIiJjKkLlMmNnOoPpQqRrSsTtUuVvWwXxYyZz 0123456789~!@#$%^&*()_+[]{}\"';:|,./<>?\`="
clear
...
Ptext="${act_key} 0123456789AaBbCcDdEeFfGgHhIiJjKkLlMmNnOoPpQqRrSsTtUuVvWwXxYyZz~!@#$%^&*()_+[]{}\"';:|,./<>?\`=" ###KEY + ABC...XYZ
